...
split summarised in Section~\ref{sec:dataset-stats}.
...
(Section~\ref{sec:signal-ablation}).
...
the matched automatic baseline falls to 0.5417 macro-F1, a gap of 0.3574 that
the ablations attribute to segmentation and pose quality rather than to the
classifier or the temporal resolution. Third, within the controlled protocol
