...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\textwidth,height=0.75\textheight,keepaspectratio]{vscode-test-explorer-playwright-panel.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{copilot-script-generation-workflow.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{copilot-code-review-workflow.png}
