...
| Claude automation skills | Selected automation skills: `code-review`, `design-test-case`, `playwright-mcp`, `script-generation` | Provides reusable automation-development and review guidance for scenario design, script generation, Playwright MCP usage, and code-review references. |
